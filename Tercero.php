...
<head>
    ...
    <script type="text/javascript" src="Funciones/Js/Consultar.js"></script>
...
<body onload="return User(), MostrarConsultar()" style="font-family: 'Josefin Sans', sans-serif;">
    <div class="grid-container">
        <div class="Menu">
            <div style="background-color:rgb(63, 109, 142); height:40px;" class="titulo">
                <h4 class="text-center" style="padding: 2%;">Consulta</h4>
            </div>
            <div style="padding: 1%;" class="container" id="UserData">
            </div>
            <div class="container">
                <hr color="black" size="20">
                <button style="color: #000;" onclick="return Consultar()" class="Btn1" type="submit"><i class="fas fa-search"></i>&nbsp;Consultar</button><br>
